//Sprint 28 Regression - 11413 - 4PM
...
GMCU.cunlockToggleCallback = function(){
    ...
    var body = GMCU.DomHandler.$("body")[0];
    var leaveBehindBanner = document.getElementById(GMCU.LeaveBehindBanner.lb_id);
    if ( GMCU.LeaveBehindBanner.visible == 1 ){
        ...
        leaveBehindBanner.style.width = "40px"
...
GMCU.OverlayLayout = function(params) {
    ...
    this.setSize = function () {
        ...
        this.containerScaler.style.maxWidth = "865px";
        ...
        this.video_wrapper.style.maxHeight = "390px";
        this.video_wrapper.style.width = this.defaultVideoSize + "%";
        this.video_wrapper.style.height = video_wrapper.offsetWidth * (9/16) + "px";
    ...
    this.getSkipText = function (unlock_allowed) {
        if (!unlock_allowed)
            ...
            if (this.params.continue_text === "" || this.params.continue_text === " ") {
                return "Continue to your site";
            } else {
                return this.params.continue_text;
            }
        }
    };
};
...
GMCU.SkipAd = {
	...
	removeSkip : function() {
      ...
      var link_image = document.getElementById('cu-skip-image');
      if (!!link_image) GMCU.DomHandler.removeEvent('click', link_image, GMCU.cunlockSkipAd);
